...
namespace LitJson
{
    ...
    public class JsonMapper
    {
        ...
        private static IJsonWrapper ReadValue (WrapperFactory factory,
                                               JsonReader reader,string key = "")//WARNER MOD added key argument
        {
            reader.Read ();
            ...
            if (key!="")
				instance.SetKey(key);//WARNER MOD
            ...
            if (reader.Token == JsonToken.ArrayStart) {
                ...
                while (true) {
                    //IJsonWrapper item = ReadValue (factory, reader,(string) reader.Value);
					IJsonWrapper item = ReadValue (factory, reader,(reader.Token==JsonToken.Int) ? null : (string) reader.Value);//WARNER MOD
                    if (reader.Token == JsonToken.ArrayEnd)
                        break;
